...
export RAY_kill_child_processes_on_worker_exit=1
...
CKPT_ARGS=(
   ...
   --save /mnt/tidal-alsh01/dataset/zeus/hecunjie/train_outputs/slime_opd_0214
   --save-interval 50
)
